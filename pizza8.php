<?php
$pizza8 = "function pizza8(x,y,titulo,ajusteTitulo,descricao,descricao2,angulo1,angulo2,angulo3,angulo4,angulo5,angulo6,angulo7,angulo8,porcentagem){
...
//-------------------------------------- angulo1
        ...
        dashGeral.fillStyle = '#b63c3c';
        dashGeral.textAlign = 'right'; 
        dashGeral.fillText(porcentagem, x+20,y+10);
        dashGeral.fill();
        dashGeral.textAlign = 'start';  
        ...
        dashGeral.beginPath();
        dashGeral.globalAlpha = 1;
        dashGeral.font = '30px Roboto, sans-serif';
        dashGeral.fillStyle = '#808080';
        dashGeral.fillText(descricao, x-130+ajusteTitulo,y+340);
        dashGeral.fillText(descricao2, x-130+ajusteTitulo,y+380);
        dashGeral.fill();
